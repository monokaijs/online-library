    ...
    <div className={styles.wrapper}>
      <div className={styles.container}>
        ...
        <div>
          ...
          <Typography.Paragraph>
            We are NorthStudio TTAS., JSC ("Company," "we," "us," "our"). We operate, as well as any other related
            products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the
            "Services").
          </Typography.Paragraph>
          <Typography.Paragraph>
            You can contact us by email at thuviendfb@gmail.com
          </Typography.Paragraph>
          <Typography.Paragraph>
            These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf
            of an entity ("you") concerning your access to and use of the Services. You agree that by accessing the
        ...
        <div className="mt-6">
          <Typography.Title className="mb-4" level={4}>OUR SERVICES</Typography.Title>
          <Typography.Paragraph>
        ...
        <div className="mt-6">
          <Typography.Title className="mb-4" level={4}>INTELLECTUAL PROPERTY RIGHTS</Typography.Title>
          ...
          <Typography.Paragraph>
            ...
            elsewhere in our Legal Terms, please address your request to: grant you the permission to post, reproduce,
            or publicly display any part of our Services or Content, you must identify us as the owners or licensors of
            the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on
        ...
        <div className="mt-6">
          <Typography.Title className="mb-4" level={4}>USER REPRESENTATIONS</Typography.Title>
          <Typography.Paragraph>
            By using the Services, you represent and warrant that: (1) you have the legal capacity and you agree to
            comply with these Legal Terms; (2) you are not a minor in the jurisdiction in which you reside; (3) you will
            not access the services through automated or non-human means, whether through a bot, script or otherwise;
            (4) you will not use the Services for any illegal or unauthorized purpose; and (5) your use of the Services
        ...
        <div className="mt-6"><Typography.Title className="mb-4" level={4}>PROHIBITED ACTIVITIES</Typography.Title>
          <Typography.Paragraph>
            ...
            <ul className="ml-10">
              ...
              <li>
                <Typography.Paragraph>
                  ...
                  using any data mining, robots, or similar data gathering and extraction tools. Delete the copyright or
              ...
              <li>
                <Typography.Paragraph>
                  ...
                  the software comprising or in any way making up a part of the Services. Except as may be the result of
                  standard search engine or Internet browser usage, use, launch, develop, or distribute any automated
                  system, including without limitation, any spider, robot, cheat utility, scraper, or offline reader
                  that accesses the Services, or use or launch any unauthorized script or other software.
                </Typography.Paragraph>
              </li>
              <li>
                <Typography.Paragraph>
        ...
        <div className="mt-6">
          <Typography.Title className="mb-4" level={4}>USER GENERATED CONTRIBUTIONS</Typography.Title>
          <Typography.Paragraph>
        ...
        <div className="mt-6">
          <Typography.Title className="mb-4" level={4}>CONTRIBUTION LICENSE</Typography.Title>
          <Typography.Paragraph>
        ...
        <div className="mt-6">
          <Typography.Title className="mb-4" level={4}>SERVICES MANAGEMENT</Typography.Title>
          <Typography.Paragraph>
        ...
        <div className="mt-6">
          <Typography.Title className="mb-4" level={4}>TERM AND TERMINATION</Typography.Title>
          <Typography.Paragraph>
        ...
        <div className="mt-6">
          <Typography.Title className="mb-4" level={4}>MODIFICATIONS AND INTERRUPTIONS</Typography.Title>
          <Typography.Paragraph>
        ...
        <div className="mt-6">
          <Typography.Title className="mb-4" level={4}>GOVERNING LAW</Typography.Title>
          <Typography.Paragraph>
            These Legal Terms shall be governed by and defined following the laws of VietNam and yourself irrevocably
            consent that the courts of VietNam shall have exclusive jurisdiction to resolve any dispute which may arise
            in connection with these Legal Terms.
          </Typography.Paragraph>
        </div>
        <div className="mt-6">
          <Typography.Title className="mb-4" level={4}>DISPUTE RESOLUTION </Typography.Title>
          <Typography.Paragraph strong>
          ...
          <Typography.Paragraph>
            ...
            this clause. The number of arbitrators shall be 3. The seat, or legal place, or arbitration shall be
            proceedings shall be 3.
          </Typography.Paragraph>
          <Typography.Paragraph>
          </Typography.Paragraph>
          The governing law of these Legal Terms shall be substantive law of VietNam.
          <Typography.Paragraph>
            The language of the proceedings shall be Vietnamese
          </Typography.Paragraph>
          <Typography.Paragraph strong>
            Restrictions
          </Typography.Paragraph>
        ...
        <div className="mt-6">
          <Typography.Title className="mb-4" level={4}>CORRECTIONS</Typography.Title>
          <Typography.Paragraph>
        ...
        <div className="mt-6">
          <Typography.Title className="mb-4" level={4}>LIMITATIONS OF LIABILITY</Typography.Title>
          <Typography.Paragraph>
        ...
        <div className="mt-6">
          <Typography.Title className="mb-4" level={4}>INDEMNIFICATION</Typography.Title>
          <Typography.Paragraph>
        ...
        <div className="mt-6">
          <Typography.Title className="mb-4" level={4}>USER DATA</Typography.Title>
          <Typography.Paragraph>
        ...
        <div className="mt-6">
          <Typography.Title className="mb-4" level={4}>ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND
            SIGNATURES</Typography.Title>
          <Typography.Paragraph>
        ...
        <div className="mt-6">
          <Typography.Title className="mb-4" level={4}>MISCELLANEOUS
          </Typography.Title>
          <Typography.Paragraph>
        ...
        <div className="mt-6">
          <Typography.Title className="mb-4" level={4}>CONTACT US</Typography.Title>
          <Typography.Paragraph>
            In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at: thuviendfb@gmail.com.
          </Typography.Paragraph>
        </div>
      </div>
    </div>
